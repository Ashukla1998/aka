...
//   const navClass = ({ isActive }) =>
//     `relative pb-1 text-sm font-sans font-medium transition-colors duration-300
...
//     <header className="bg-white shadow-sm sticky top-0 z-50">
//       <div className="border-b border-gray-200">
//         <div className="flex items-center justify-between px-6 py-2 text-sm font-sans text-gray-700">

//           <div className="hidden sm:block" />

//           {/* RIGHT SIDE */}
//           <div className="flex items-center gap-6">
//             <Link to="/contact" className="hover:text-arcadisOrange">
//               Contact
//             </Link>
...
//               className="flex items-center gap-1 hover:text-gray-900"
//             >
//               <img src={whatsapp} alt="WhatsApp" className="w-25 h-8" />
//             </button>
//           </div>
//         </div>
//       </div>
...
//           <div className="hidden sm:block leading-tight">
//             <p className="font-serif font-medium text-base tracking-wide">
//               Dehradun Based Architect
//             </p>
...
//               className={({ isActive }) =>
//                 isActive
//                   ? "font-sans font-medium text-arcadisOrange"
//                   : "font-sans font-medium text-gray-700 hover:text-gray-900"
//               }
//             >
//               {link.label}
//             </NavLink>
...
export default function Navbar() {
  ...
  const navClass = ({ isActive }) =>
    `relative pb-1 text-sm font-sans font-medium transition-colors duration-300
     ${
       isActive
         ? "text-arcadisOrange"
         : "text-gray-700 hover:text-arcadisOrange"
     }`;
  ...
  return (
    <header className="bg-white sticky top-0 z-50">
      {/* ================= TOP BAR ================= */}
      <div className="border-b border-gray-200">
        <div className="flex items-center justify-between px-6 py-2 text-xs font-sans text-gray-700">

          <div className="hidden sm:block" />

          <div className="flex items-center gap-6 font-serif font-medium">
            <Link to="/contact" className="font-sans text-sm font-medium transition-colors duration-300 text-gray-700 hover:text-arcadisOrange">
              Contact
            </Link>

            <Link to="/career" className="font-sans text-sm font-medium transition-colors duration-300 text-gray-700 hover:text-arcadisOrange">
              Careers
            </Link>
          ...
          {links.map((link) => (
            <NavLink
              ...
              className={({ isActive }) =>
                isActive
                  ? "font-sans font-medium text-arcadisOrange"
                  : "font-sans font-medium text-gray-700 hover:text-arcadisOrange"
              }
            >
              {link.label}
            </NavLink>
