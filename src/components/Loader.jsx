        ...
        <div className="flex items-end justify-center leading-none overflow-hidden pb-1">
          ...
          <div className="overflow-hidden">
            <motion.span
              ...
              initial="hidden"
              animate="visible"
              className="inline-block text-6xl md:text-7xl font-extralight tracking-tight text-arcadisOrange"
            >
              a
            </motion.span>
          </div>
          ...
          <div className="overflow-hidden ">
            <motion.span
              ...
              className="inline-block text-6xl md:text-7xl font-light tracking-[0.06em] text-white"
            >
              K
            </motion.span>
          </div>
