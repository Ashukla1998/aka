...
//             <h2 className="font-serif text-4xl md:text-5xl mb-6 font-medium">
//               How We Think
//             </h2>
...
//                 <h3 className="text-[35px] font-medium mb-4">
//                   {item.title}
//                 </h3>
...
//           {/* Eyebrow */}
//           <p className="text-s tracking-[0.35em] uppercase text-arcadisOrange mb-6">
//             Collaboration
//           </p>
...
//       >
//         <div className="flex items-center gap-6 text-[16px] font-Helvetica text-gray-700">
...
//                        text-arcadisOrange hover:text-white
//                        hover:bg-arcadisOrange
    ...
    <main className="bg-white overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-16 mb-36">
            {[
              ...
              >
                ...
                <h4 className="font-serif font-medium text-lg mb-4">
                  {service.title}
                </h4>
      ...
      >
        <div className="max-w-3xl mx-auto">
          ...
          <p className="font-body text-gray-600 mb-14 leading-relaxed">
            Whether you’re planning a new project, rethinking an existing space,
            or exploring sustainable design strategies, we’d be happy to collaborate.
          </p>
      ...
      <motion.div
        ...
        className="px-10 md:px-20 py-10"
      >
        <div className="flex items-center gap-6 text-base font-sans text-gray-700">
            ...
            {[FaFacebookF, FaInstagram, FaLinkedinIn, FaTwitter].map(
              (Icon, i) => (
                <motion.a
                  ...
                  className="w-9 h-9 flex items-center justify-center
                  border border-arcadisOrange rounded-full
                  text-arcadisOrange hover:bg-arcadisOrange hover:text-white
                  transition-colors duration-300"
                >
                  <Icon size={14} />
                </motion.a>
